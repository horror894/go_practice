...
func startQuiz() {
	...
	var input int
	for input != 3 {
		fmt.Print("How you could output string and numeric together using fmt\n")
		fmt.Print("1. fmt.Print('variable' + 'your text')\n")
		fmt.Print("2. fmt.Print(test1)")
		fmt.Print("3. fmt.Print(other)")
		fmt.Print("4. fmt.Print(last)")
		fmt.Scan(&input)
	}
